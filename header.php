            ...
            <div class="container">
                <div class="col-xs-8 header-bottom-left">
                    <div class="col-xs-2 logo">
                        <h1><a href="index.php"><img src="images/logo2.png" alt="logo" style="width: 145px; margin-left: -20px; margin-top: -5px;"></a></h1>
                    </div>
                    <div class="col-xs-6 menu">
                        ...
                        <ul class="megamenu skyblue">
                            ...
                            <li><a class="color1" href="keranjang.php" style="font-size: 16px;">Keranjang</a></li>
